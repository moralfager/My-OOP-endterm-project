 ...
 * @author sushi
 */
public class LoginSignUpForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Design by technoKID");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(180, 590, 160, 20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginSignUpForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginSignUpForma().setVisible(true);
            }
        });
    }
